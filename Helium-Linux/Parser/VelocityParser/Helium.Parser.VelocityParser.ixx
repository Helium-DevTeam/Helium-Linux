...
export module Helium.Parser.VelocityParser;
...
namespace Helium {
	map<string, string> VelocityParser::ParseServerStarting(string_view raw) {
	}
	map<string, string> VelocityParser::ParseServerStarted(string_view raw) {
	}
	map<string, string> VelocityParser::ParseServerInfo(string_view raw) {
	}
	map<string, string> VelocityParser::ParseServerPlayerChat(string_view raw) {
	}
	map<string, string> VelocityParser::ParseServerOverload(string_view raw) {
	}
	map<string, string> VelocityParser::ParseServerStopping(string_view raw) {
	}
	map<string, string> VelocityParser::ParseServerStopped(string_view raw) {
	}
	string VelocityParser::GetServerPureOutput(string_view raw) {
	}
}*/