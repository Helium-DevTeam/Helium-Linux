...
export module Helium.Parser.CatParser;
...
export namespace Helium {
	class CatParser : public AbstractParser {
	public:
		CatParser() {}
...
namespace Helium {
	map<string, string> CatParser::ParseServerStarting(string_view raw) {
	}
	map<string, string> CatParser::ParseServerStarted(string_view raw) {
	}
	map<string, string> CatParser::ParseServerInfo(string_view raw) {
	}
	map<string, string> CatParser::ParseServerPlayerChat(string_view raw) {
	}
	map<string, string> CatParser::ParseServerOverload(string_view raw) {
	}
	map<string, string> CatParser::ParseServerStopping(string_view raw) {
	}
	map<string, string> CatParser::ParseServerStopped(string_view raw) {
	}
	string CatParser::GetServerPureOutput(string_view raw) {
	}
}*/