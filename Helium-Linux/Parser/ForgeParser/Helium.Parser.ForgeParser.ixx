...
export module Helium.Parser.ForgeParser;
...
export namespace Helium {
	class ForgeParser : public AbstractParser {
	public:
		ForgeParser() {}
...
namespace Helium {
	map<string, string> ForgeParser::ParseServerStarting(string_view raw) {
	}
	map<string, string> ForgeParser::ParseServerStarted(string_view raw) {
	}
	map<string, string> ForgeParser::ParseServerInfo(string_view raw) {
	}
	map<string, string> ForgeParser::ParseServerPlayerChat(string_view raw) {
	}
	map<string, string> ForgeParser::ParseServerOverload(string_view raw) {
	}
	map<string, string> ForgeParser::ParseServerStopping(string_view raw) {
	}
	map<string, string> ForgeParser::ParseServerStopped(string_view raw) {
	}
	string ForgeParser::GetServerPureOutput(string_view raw) {
	}
}*/