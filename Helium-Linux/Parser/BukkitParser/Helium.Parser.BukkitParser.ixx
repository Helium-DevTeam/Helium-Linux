...
export module Helium.Parser.BukkitParser;
...
export namespace Helium {
	class BukkitParser : public AbstractParser {
	public:
		BukkitParser() {}
...
namespace Helium {
	map<string, string> BukkitParser::ParseServerStarting(string_view raw) {
	}
	map<string, string> BukkitParser::ParseServerStarted(string_view raw) {
	}
	map<string, string> BukkitParser::ParseServerInfo(string_view raw) {
	}
	map<string, string> BukkitParser::ParseServerPlayerChat(string_view raw) {
	}
	map<string, string> BukkitParser::ParseServerOverload(string_view raw) {
	}
	map<string, string> BukkitParser::ParseServerStopping(string_view raw) {
	}
	map<string, string> BukkitParser::ParseServerStopped(string_view raw) {
	}
	string BukkitParser::GetServerPureOutput(string_view raw) {
	}
}*/