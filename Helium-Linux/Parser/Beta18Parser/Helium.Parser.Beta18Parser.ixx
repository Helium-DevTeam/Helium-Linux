...
export module Helium.Parser.Beta18Parser;
...
export namespace Helium {
	class Beta18Parser : public AbstractParser {
	public:
		Beta18Parser() {}
...
namespace Helium {
	map<string, string> Beta18Parser::ParseServerStarting(string_view raw) {
	}
	map<string, string> Beta18Parser::ParseServerStarted(string_view raw) {
	}
	map<string, string> Beta18Parser::ParseServerInfo(string_view raw) {
	}
	map<string, string> Beta18Parser::ParseServerPlayerChat(string_view raw) {
	}
	map<string, string> Beta18Parser::ParseServerOverload(string_view raw) {
	}
	map<string, string> Beta18Parser::ParseServerStopping(string_view raw) {
	}
	map<string, string> Beta18Parser::ParseServerStopped(string_view raw) {
	}
	string Beta18Parser::GetServerPureOutput(string_view raw) {
	}
}*/